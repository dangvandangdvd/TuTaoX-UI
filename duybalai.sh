#!/bin/bash
apt-get update -y
bash <(curl -Ls https://raw.githubusercontent.com/dangvandangdvd/X-UI-VH/master/install.sh)
ufw allow 54321
ufw allow 443
ufw allow 80
ufw allow 80/tcp
...
echo " Vào Nhóm Zalo Chúng Tôi Cùng Giao Lưu Nhé : https://www.facebook.com/groups/forexthucchiendvd "
echo " Bây Giờ Bạn Vào X-UI Sửa Thông Tin Và Tạo Vmess Trojan Vless Đợi Gì Nữa Nào "
echo " Liên Hệ Với Minh Duy Qua Điện Thoại & Zalo Để Có Giá VPS Hợp Lý Nhé : 0988909382 "
